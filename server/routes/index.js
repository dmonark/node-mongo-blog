...
const blogValidator = require('../validator/post');
...
module.exports = (app) => {
  ...
  app.post('/api/user/update', authChecker.checkToken, userValidator.update, userController.update);
	app.post('/api/user/change_password', authChecker.checkToken, userValidator.changePassword, userController.changePassword);
